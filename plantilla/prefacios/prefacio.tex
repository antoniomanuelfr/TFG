...
\linebreak
To keep a country economically sound, it will need profitable companies, as these are in charge of creating job vacancies and pushing the economic growth.\\
For this reason, detecting people capable of creating new companies and helping them to get the resources and advice, can be important for the economic growth of a country.
...
\linebreak
Solving this kind of problem using classic techniques may not be the best choice, as this can be time and resource consuming. The goal of  Machine Learning is to ease this kind of problem. This approach will use data to build a mathematical model that will predict the data used to create the model and, most important, new data that the model hasn't used.
